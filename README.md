...
**Huomioita:** Pelillä kestää hetki näyttää mitään.
...
Liikkumista varten game.js sisältää tapahtumankuuntelijoita GUI:n napeille sekä myös näppäimistön nuolinäppäimille. Nämä kutsuvat tapahtumankäsittelijöitä movePlayer() ja turnPlayer() tietyillä argumenteilla, riippuen liikutaanko eteenpäin vaiko taaksepäin, tai käännytäänkö oikealle vaiko vasemmalle. Itse liikkumis- ja kääntymismetodit kuuluvat objekti-orientoituun tapaan player.js luokkaan, jossa pelaajan liikkumista myös rajoitetaan, jotta gridin ulkopuolelle ei päästä, ja jotta pelaaja ei kykenisi kääntymään olemassaolemattomaan suuntaan. Liikkuessa taaksepäin, tapahtumankuuntelija syöttää liikkumismetodille päinvastaisen suunta-argumentin ((d + 2) % 4).
